...
(for %%a in (%list%) do (
   ...
   (echo ---
    ...
    echo.
    echo Sur la commune de **%%a**, quels sont les diagnostics immobiliers obligatoires à réaliser pour votre bien immobilier lors de la vente ou de la location ?
    echo.
